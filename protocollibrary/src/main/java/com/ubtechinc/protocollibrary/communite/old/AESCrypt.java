...
public final class AESCrypt {
    ...
    private static final byte[] ivBytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x05, 0x05};
    ...
    public static String decrypt(final String password, String base64EncodedCipherText)
        ...
        try {
            ...
            log("base64EncodedCipherText", base64EncodedCipherText + " password : " + password);
