...
//    private Robot2SocketMsgMgr mSocketService;
...
/*                List<SocketClientHandler> client = mSocketService
                        .getmClientManager().getmClientList();
                for (SocketClientHandler alphaSocketClientHandler : client) {
...
/*
    public void setSocketService(Robot2SocketMsgMgr mSocketService) {
        // TODO Auto-generated method stub
