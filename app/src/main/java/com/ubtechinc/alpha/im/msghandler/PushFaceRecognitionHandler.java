...
public class PushFaceRecognitionHandler implements IMJsonMsgHandler{
    ...
    public void handleMsg(int requestCmdId, int responseCmdId, IMJsonMsg jsonRequest, String peer) {
        ...
        aSkillsProxy.call("/face/whoAmI",  new ResponseCallback() {
            @Override
            public void onResponse(Request request, Response response) {
                LogUtils.d(TAG, "/face/whoAmI success ！！！");
            }

            @Override
            public void onFailure(Request request, CallException e) {
                LogUtils.d(TAG, "/face/whoAmI fail ！！！");
