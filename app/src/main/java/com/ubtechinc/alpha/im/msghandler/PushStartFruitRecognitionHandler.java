...
public class PushStartFruitRecognitionHandler implements IMJsonMsgHandler{
    public static final String TAG = PushStartFruitRecognitionHandler.class.getSimpleName();
    @Override
    public void handleMsg(int requestCmdId, int responseCmdId, IMJsonMsg jsonRequest, String peer) {
        ...
        aSkillsProxy.call("/fruit/what_fruit",  new ResponseCallback() {
            @Override
            public void onResponse(Request request, Response response) {
                LogUtils.d(TAG, "/fruit/what_fruit success ！！！");
            }

            @Override
            public void onFailure(Request request, CallException e) {
                LogUtils.d(TAG, "/fruit/what_fruit fail ！！！");
