...
import com.ubtrobot.framework.db.annotation.Column;
import com.ubtrobot.framework.db.annotation.GenerationType;
import com.ubtrobot.framework.db.annotation.Id;
import com.ubtrobot.framework.db.annotation.Table;
...
public class AlarmInfo {
    ...
    public String toString() {
        return "AlarmInfo{" +
                ...
                ", repeat=" + repeat +
                ", isUseAble=" + isUseAble +
                ", actionStartName='" + actionStartName + '\'' +
                ", acitonEndName='" + acitonEndName + '\'' +
