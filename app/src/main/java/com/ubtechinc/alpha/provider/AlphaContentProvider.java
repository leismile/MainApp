...
import com.ubtrobot.framework.provider.ContractContentProviderBase;
import com.ubtrobot.framework.provider.DatabaseContract;

import java.util.List;

/**
 * @desc : 主服务数据库:包含：闹钟，图片，appinfo关系表
 * @author: Logic
