...
public class RobotCommuniteManager<T> {
    ...
    public void sendData(int cmdId,
                         String version,
                         GeneratedMessageLite requestBody,
                         String peer,
                         @NonNull ICallback<AlphaMessageOuterClass.AlphaMessage> dataCallback) {
        mConnection.sendMessage(cmdId, version, requestBody, peer, dataCallback);
    }


    public void sendDataToRobot(int cmdId,
                                String version,
                                GeneratedMessageLite requestBody,
                                String peer,
                                @NonNull ICallback<T> dataCallback) {
